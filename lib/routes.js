...
var index = require('./controllers'),
    ...
    admin = require('./controllers/serverFunctions'),
...
module.exports = function(app) {
  ...
  //run functions
  //setup
  app.post('/api/admin/setup',  middleware.auth, admin.setup);
  app.post('/api/admin/refreshsetup',  middleware.auth, admin.refreshSetup);
  app.post('/api/admin/calcplayers',  middleware.auth, admin.calcPlayers);
  app.post('/api/admin/calcteams',  middleware.auth, admin.calcTeams);
  app.post('/api/admin/calcleagues',  middleware.auth, admin.calcLeagues);
